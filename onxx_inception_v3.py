...
model_url = "https://github.com/onnx/models/blob/main/vision/classification/inception_and_googlenet/inception_v2/model/inception-v2-9.onnx?raw=true";
print(model_url)
model_path = download_testdata(model_url, "inception_v2.onnx", module="onnx")
print(model_path)
