...
model_url = "https://github.com/onnx/models/blob/main/vision/classification/mobilenet/model/mobilenetv2-7.onnx?raw=true";
print(model_url)
model_path = download_testdata(model_url, "mobilenet.onnx", module="onnx")
print(model_path)
